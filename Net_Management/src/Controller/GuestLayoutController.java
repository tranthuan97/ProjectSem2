 ...
 * @author User
 */
public class GuestLayoutController implements Initializable {
...
//    private TableColumn<Models.ModelAccountTable, String> col_balance;
    ...
    public void GuestHandle() {
        Parent register;
        try {
            register = FXMLLoader.load(getClass().getResource("/FXML/GuestRegister.fxml"));
